...
```{r}
if (interactive() && identical(Sys.info()[["sysname"]], "Windows")) {
	.libPaths("../renv/library/windows/R-4.5/x86_64-w64-mingw32/")
}
.libPaths()
```
...
This a tabular `DataFrame` structure whose columns can be listed as follows:
