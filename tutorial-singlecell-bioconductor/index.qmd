...
#### Export to Loom file format

R objects are traditionally saved to RData or RDS files.
However those file formats are specific to R and deemed unsafe.

To be saved to the safer `loom` file format, `SingleCellExperiment` objects must be converted to the `SingleCellLoomExperiment` class before they can be saved to disk as follows:



#### Inspect the `SingleCellExperiment` object.

A summary view of the `SingleCellLoomExperiment` can be displayed as follows:
